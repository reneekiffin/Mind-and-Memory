...
const TRIVIA = [
  ...
  { section:'Passion', q:'On what animal did Jesus ride into Jerusalem on Palm Sunday?', a:'A donkey', choices:['A horse','A donkey','A camel','He walked'], fact:'Matthew 21 — fulfilling Zechariah 9:9: "thy King cometh… lowly, and riding upon an ass".' },
  { section:'Passion', q:'What meal did Jesus share with his disciples on the night before his death?', a:'The Last Supper', choices:['The Last Supper','The Wedding Feast','Passover Seder at Bethany','The Breakfast on the Beach'], fact:'Matthew 26 — at the Passover meal Jesus took bread and wine and instituted the Lord\'s Supper.' },
  { section:'Passion', q:'For how many pieces of silver did Judas betray Jesus?', a:'Thirty', choices:['Twelve','Thirty','Fifty','One hundred'], fact:'Matthew 26:15 — fulfilling Zechariah 11:12-13. He later threw the money back into the temple.' },
  { section:'Passion', q:'In which garden was Jesus arrested?', a:'Gethsemane', choices:['Eden','Gethsemane','The Garden of Olives','The Garden of Joseph'], fact:'Matthew 26 — Jesus prayed in agony three times while his disciples slept, then was arrested by a crowd from the chief priests.' },
  { section:'Passion', q:'How many times did Peter deny Jesus before the rooster crowed?', a:'Three', choices:['Once','Twice','Three times','Seven times'], fact:'Matthew 26 — Jesus had foretold it; when Peter realised what he had done he wept bitterly.' },
  { section:'Passion', q:'Which Roman governor sentenced Jesus to be crucified?', a:'Pontius Pilate', choices:['Felix','Festus','Pontius Pilate','Caesar Augustus'], fact:'Matthew 27 — Pilate washed his hands of Jesus\'s blood, but yielded to the crowd\'s demand for crucifixion.' },
  { section:'Passion', q:'What did the Roman soldiers place on Jesus\'s head before crucifying him?', a:'A crown of thorns', choices:['A crown of olive branches','A crown of thorns','An iron helmet','A linen turban'], fact:'Matthew 27:29 — they mocked him as "King of the Jews" while pressing the thorny crown onto his head.' },
  { section:'Passion', q:'Who was forced to carry Jesus\'s cross?', a:'Simon of Cyrene', choices:['Simon Peter','Simon of Cyrene','Joseph of Arimathea','Barabbas'], fact:'Matthew 27:32 — the soldiers compelled Simon, a passer-by from Cyrene in North Africa, to bear the cross.' },
  { section:'Passion', q:'What was the name of the place outside Jerusalem where Jesus was crucified?', a:'Golgotha (the place of the skull)', choices:['Mount Sinai','Mount Tabor','Golgotha (the place of the skull)','The Mount of Olives'], fact:'John 19:17 — Golgotha is Aramaic; the Latin equivalent is "Calvary".' },
  { section:'Passion', q:'How many criminals were crucified alongside Jesus?', a:'Two', choices:['One','Two','Three','Four'], fact:'Luke 23 — one mocked him; the other asked Jesus to remember him when he came into his kingdom.' },
  { section:'Passion', q:'Who provided the new tomb in which Jesus was buried?', a:'Joseph of Arimathea', choices:['Nicodemus','Joseph of Arimathea','Mary Magdalene','Lazarus'], fact:'Matthew 27:57-60 — a wealthy disciple, Joseph laid Jesus in his own newly cut rock tomb.' },
  { section:'Resurrection', q:'On which day did Jesus rise from the dead?', a:'The third day', choices:['The same day','The second day','The third day','The seventh day'], fact:'Luke 24 — early on the first day of the week, women coming to the tomb found the stone rolled away.' },
  { section:'Resurrection', q:'To whom did the risen Jesus first appear?', a:'Mary Magdalene', choices:['Peter','John','Mary Magdalene','Mary the mother of Jesus'], fact:'John 20 — at first she mistook him for the gardener until he called her by name.' },
  { section:'Resurrection', q:'On which road did the risen Jesus walk with two disciples who did not at first recognise him?', a:'The road to Emmaus', choices:['The road to Damascus','The road to Emmaus','The road to Jericho','The road to Bethlehem'], fact:'Luke 24:13-35 — they recognised him in the breaking of the bread.' },
  { section:'Resurrection', q:'For how many days did the risen Jesus appear to his disciples before ascending to heaven?', a:'Forty', choices:['Three','Seven','Twelve','Forty'], fact:'Acts 1:3 — he appeared to them over forty days, speaking about the kingdom of God.' },

  // ── Acts & the Apostles ──────────────────────────────
  { section:'Acts', q:'On what feast day did the Holy Spirit descend on the disciples in Jerusalem?', a:'Pentecost', choices:['Passover','Pentecost','Tabernacles','The Day of Atonement'], fact:'Acts 2 — a sound like a rushing wind filled the house; tongues of fire rested on each disciple and they spoke in many languages.' },
  { section:'Acts', q:'Who was chosen to replace Judas Iscariot among the twelve apostles?', a:'Matthias', choices:['Stephen','Barnabas','Matthias','Mark'], fact:'Acts 1:23-26 — the eleven cast lots between Joseph (Barsabbas) and Matthias; the lot fell to Matthias.' },
  { section:'Acts', q:'Who was the first Christian martyr, stoned to death for his preaching?', a:'Stephen', choices:['Stephen','James','Peter','Paul'], fact:'Acts 7 — Stephen saw heaven opened and the Son of Man at God\'s right hand as he was being stoned.' },
  { section:'Acts', q:'Who held the coats of those who stoned Stephen?', a:'Saul (later Paul)', choices:['Pilate','Saul (later Paul)','Caiaphas','Nicodemus'], fact:'Acts 7:58 — Saul of Tarsus consented to Stephen\'s death; he was later transformed into the Apostle Paul.' },
  { section:'Acts', q:'On what road was Saul travelling when he saw a blinding light and met the risen Jesus?', a:'The road to Damascus', choices:['The road to Emmaus','The road to Damascus','The road to Jericho','The road to Antioch'], fact:'Acts 9 — "Saul, Saul, why do you persecute me?" He was blind for three days before being healed by Ananias.' },
  { section:'Acts', q:'In which city were Jesus\'s followers first called Christians?', a:'Antioch', choices:['Jerusalem','Antioch','Ephesus','Rome'], fact:'Acts 11:26 — "the disciples were called Christians first in Antioch".' },
  { section:'Acts', q:'Whom did an angel free from prison by causing his chains to fall off?', a:'Peter', choices:['Peter','John','Paul','Silas'], fact:'Acts 12 — Herod had Peter chained between two soldiers; the angel led him out past the iron gate that opened by itself.' },
  { section:'Acts', q:'Who was the Ethiopian official Philip baptised on a desert road?', a:'A eunuch and treasurer to the queen', choices:['A Roman centurion','A eunuch and treasurer to the queen','A Pharisee','A merchant'], fact:'Acts 8 — the eunuch was reading Isaiah; Philip explained that the prophecy was about Jesus, and they stopped at water to baptise him.' },
  { section:'Acts', q:'Who was the Roman centurion at Caesarea whose household received the Holy Spirit?', a:'Cornelius', choices:['Julius','Cornelius','Felix','Festus'], fact:'Acts 10 — the conversion of Cornelius opened the gospel to Gentiles, breaking down the wall between Jew and non-Jew.' },
  { section:'Paul', q:'Who travelled with Paul on his first missionary journey?', a:'Barnabas', choices:['Silas','Timothy','Barnabas','Mark'], fact:'Acts 13-14 — the church at Antioch sent out Barnabas and Saul; they sailed first to Cyprus, then on to Asia Minor.' },
  { section:'Paul', q:'In what Macedonian city were Paul and Silas thrown in jail and freed by an earthquake?', a:'Philippi', choices:['Athens','Corinth','Thessalonica','Philippi'], fact:'Acts 16 — at midnight, while they were singing hymns, an earthquake shook the prison; the jailer and his household believed and were baptised.' },
  { section:'Paul', q:'In which city did Paul preach to philosophers about the "Unknown God" at the Areopagus?', a:'Athens', choices:['Rome','Athens','Ephesus','Corinth'], fact:'Acts 17 — Paul quoted Greek poets and proclaimed Jesus and the resurrection. Some mocked, others believed.' },
  { section:'Paul', q:'On the way to Rome, Paul was shipwrecked on which Mediterranean island?', a:'Malta', choices:['Cyprus','Crete','Malta','Sicily'], fact:'Acts 27-28 — all 276 aboard reached the island safely; Paul was bitten by a viper but suffered no harm.' },
  { section:'Paul', q:'Which young companion did Paul call his "true son in the faith"?', a:'Timothy', choices:['Timothy','Titus','Luke','Mark'], fact:'1 Timothy 1:2 — Timothy joined Paul on his second missionary journey and later led the church at Ephesus.' },
  { section:'Paul', q:'Which book describes the End Times and visions of seven churches and seven seals?', a:'Revelation', choices:['Daniel','Revelation','Ezekiel','Hebrews'], fact:'Revelation was written by the apostle John while exiled on the island of Patmos.' },
  { section:'Paul', q:'On which island was John exiled when he received the visions of Revelation?', a:'Patmos', choices:['Cyprus','Patmos','Crete','Rhodes'], fact:'Revelation 1:9 — "I John… was in the isle that is called Patmos, for the word of God".' }
];
